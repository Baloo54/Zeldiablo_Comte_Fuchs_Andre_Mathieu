 ...
 * 
 */
public class Escalier_Up extends Case{

    private String IMGPATH = "zeldiablo/src/main/resources/textures/stairs_upward.png";
     ...
     * @param dy
     */
    public Escalier_Up(int dx, int dy) throws Exception{
        super(dx, dy);
        setColor(Color.DARKGRAY);
        setNom("Escalier_Monter");
        getData();
    }
    /**
